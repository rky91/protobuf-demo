...
type LaptopServiceClient interface {
	...
	GetLaptopById(ctx context.Context, in *GetLaptopRequest, opts ...grpc.CallOption) (*GetLaptopResponse, error)
}
...
func (c *laptopServiceClient) GetLaptopById(ctx context.Context, in *GetLaptopRequest, opts ...grpc.CallOption) (*GetLaptopResponse, error) {
	out := new(GetLaptopResponse)
	err := c.cc.Invoke(ctx, "/pb.LaptopService/GetLaptopById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LaptopServiceServer interface {
	...
	GetLaptopById(context.Context, *GetLaptopRequest) (*GetLaptopResponse, error)
}
...
func (UnimplementedLaptopServiceServer) GetLaptopById(context.Context, *GetLaptopRequest) (*GetLaptopResponse, error) {
...
func _LaptopService_GetLaptopById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.LaptopService/GetLaptopById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LaptopServiceServer).GetLaptopById(ctx, req.(*GetLaptopRequest))
	}
	return interceptor(ctx, in, info, handler)
}
